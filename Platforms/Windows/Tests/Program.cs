...
try
{
    ...
    Assert(UpdateService.IsNewer("v1.1.2", "1.1.1"), "A newer release version was not detected.");
    Assert(!UpdateService.IsNewer("v1.1.1", "1.1.1"), "The installed release was treated as newer.");
    Assert(!UpdateService.IsNewer("v1.1.0", "1.1.1"), "An older release was treated as newer.");
