...
try
{
    ...
    Assert(UpdateService.IsNewer("v4.9.3", "4.9.2"), "A patch release was not detected as newer.");
    Assert(!UpdateService.IsNewer("v4.9.3", "4.9.3"), "The installed release was treated as newer.");
    Assert(!UpdateService.IsNewer("v4.9.2", "4.9.3"), "An older release was treated as newer.");
