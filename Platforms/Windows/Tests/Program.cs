...
try
{
    ...
    Assert(UpdateService.IsNewer("v4.9", "1.1.2"), "The unified release version was not detected as newer.");
    Assert(!UpdateService.IsNewer("v4.9", "4.9"), "The installed release was treated as newer.");
    Assert(!UpdateService.IsNewer("v4.8", "4.9"), "An older release was treated as newer.");
