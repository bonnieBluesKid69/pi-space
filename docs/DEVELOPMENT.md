...
- `Resources/PiSpace.html` contains the interface, styling, and browser-side RPC event rendering.
- `Sources/WakePi.swift` is an optional menu-bar app using AVFoundation and Speech.
